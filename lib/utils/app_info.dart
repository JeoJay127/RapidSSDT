...
class AppInfo {
  ...
  static Future<String> get buildNumber async => (await _getPackageInfo()).buildNumber;
  static Future<String> get appName async => (await _getPackageInfo()).appName;
  static Future<String> get packageName async => (await _getPackageInfo()).packageName;
}